...
**APIs.json:** [https://apis.io/amazon-lightsail](https://apis.io/amazon-lightsail)
...
- [openapi](https://api.apis.guru/v2/specs/amazonaws.com/lightsail/latest/openapi.yaml) — [OpenAPI Specification](https://spec.openapis.org/oas/latest.html)
...
- [JSON Schema](json-schema/amazon-lightsail-instance-schema.json) — [JSON Schema](https://json-schema.org/specification)
- [JSON-LD](json-ld/amazon-lightsail-context.jsonld) — [JSON-LD](https://www.w3.org/TR/json-ld11/)
- [Postman Collection](collections/amazon-lightsail.postman_collection.json) — [Postman Collection 2.1](https://schema.getpostman.com/json/collection/v2.1.0/collection.json)
- [Open Collection](collections/amazon-lightsail.opencollection.json) — [Open Collection 1.0](https://schema.opencollection.com/opencollection/v1.0.0.json)
...
- [stack-overflow](https://stackoverflow.com/questions/tagged/amazon-lightsail)
...
- [Spectral Rules](rules/amazon-lightsail-spectral-rules.yml)
- [Vocabulary](vocabulary/amazon-lightsail-vocabulary.yaml)
